...
st.text("""Please enter the SQL query in the text box below to detect if this query is a SQLi attack.""")	# Set the text of the page
...
with st.form("SQLi Detection"):											# Create a form with name "SQLi Detection"
		...
		if st.form_submit_button("Predict"):							# if the user clicks the submit button
